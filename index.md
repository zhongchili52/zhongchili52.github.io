...
My research broadly centers around decision making (e.g., customer decisions, risky decisions) and intersectional health disparities (e.g., behavioral addictions, minority stress). I am also interested in the social and cognitive mechanisms underlying behaviors that have multifaceted influences on health and well-being. I am fascinated by employing novel and advanced techniques in machine learning, statistical and computational modeling, and engineering to enhance detection and prediction accuracy and tackle the complexity and nonlinearity inherent in psychological and behavioral sciences. A significant portion of my work is dedicated to historically underrepresented and stigmatized populations, including sexual and gender minorities, single individuals, and racial/ethnic minorities.
